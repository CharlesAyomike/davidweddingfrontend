...
const Grid = () => {
  ...
  const images = [
    ...
    { id: 4, src: '/ph3.jpg', alt: 'Gallery Image 4', width: 'col-span-1' },
    { id: 5, src: '/ph4.jpg', alt: 'Gallery Image 5', width: 'col-span-1' },
    { id: 6, src: '/ph5.jpg', alt: 'Gallery Image 6', width: 'col-span-2' },
    { id: 7, src: '/ph6.jpg', alt: 'Gallery Image 7', width: 'col-span-1' },
    { id: 8, src: '/ph7.jpg', alt: 'Gallery Image 8', width: 'col-span-2' },
    { id: 9, src: '/ph8.jpg', alt: 'Gallery Image 9', width: 'col-span-1' },
    { id: 9, src: '/ph9.jpg', alt: 'Gallery Image 10', width: 'col-span-1' },
    { id: 10, src: '/ph10.jpg', alt: 'Gallery Image 11', width: 'col-span-1' },
  ];
